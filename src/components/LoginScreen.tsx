...
export const LoginScreen = ({ onLogin, onGuest }: { onLogin: () => void; onGuest: () => void }) => {
  return (
        ...
        <div className="max-w-sm w-full mx-auto space-y-8 pb-12 mt-12 md:mt-0 pt-16 md:pt-0">
           ...
           <div className="pt-6 space-y-3">
              ...
              >
               ...
               <button
                  onClick={onGuest}
                  className="w-full bg-white/5 text-gray-300 px-6 py-4 rounded-xl font-semibold hover:bg-white/10 transition-all active:scale-[0.98] flex items-center justify-center gap-3 text-base border border-white/10"
              >
               ...
               <p className="text-center text-xs text-gray-500 pt-1">Guest mode: projects saved locally only</p>
           </div>
        </div>
